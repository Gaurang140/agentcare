...
# backend/ (the parent of this alembic/ directory) must be on sys.path so
# `import app...` works regardless of the current working directory alembic
# was invoked from.
...
# Importing app.models registers every table on Base.metadata so autogenerate
